...
import { CheckSquare, FileText, Shield, AlertTriangle } from 'lucide-react';
import { DocumentCard } from '../DocumentCard';
import type { PhaseDetails } from '../../types/phases';

interface FinalInspectionDetailsProps {
  details: PhaseDetails;
}

export function FinalInspectionDetails({ details }: FinalInspectionDetailsProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Approvals</h3>
        <div className="space-y-3">
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Final Checklist</h3>
        <div className="space-y-3">
      ...
      {details.notes && (
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-900 dark:text-white">Inspector Notes</h3>
