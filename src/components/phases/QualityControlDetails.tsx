...
import { CheckSquare, Camera, FileText, AlertTriangle } from 'lucide-react';
import { DocumentCard } from '../DocumentCard';
import type { PhaseDetails } from '../../types/phases';

interface QualityControlDetailsProps {
  details: PhaseDetails;
}

export function QualityControlDetails({ details }: QualityControlDetailsProps) {
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Quality Control Checklist</h3>
      ...
      {details.notes && (
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-900 dark:text-white">Issues & Concerns</h3>
