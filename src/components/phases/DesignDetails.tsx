...
import { FileText, CheckSquare, Download, ExternalLink } from 'lucide-react';
...
export function DesignDetails({ details }: DesignDetailsProps) {
  return (
    <div className="space-y-6">
      <div className="space-y-4">
        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Design Documents</h3>
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-medium text-gray-900 dark:text-white">Design Review</h3>
        <div className="space-y-3">
      ...
      {details.notes && (
        <div className="space-y-4">
          <h3 className="text-sm font-medium text-gray-900 dark:text-white">Design Notes</h3>
