...
export function Sidebar() {
  ...
  return (
    <aside className='hidden lg:flex lg:flex-col fixed left-0 top-0 px-4 py-4 h-full'>
      <div className={`${
        isCollapsed ? 'w-16' : 'w-64'
      } bg-white dark:bg-[#09090B] h-screen transition-all duration-300 flex flex-col justify-between border border-gray-900 rounded-lg`}>

        <div className='navgroup'>
          <div className="logo-wrap p-4 border-b border-gray-200 dark:border-gray-800">
          ...
          <div className="main-nav flex-1 px-2 py-4 space-y-1 overflow-y-auto">
        ...
        <div className="nav-footer px-2 py-4 border-t border-gray-200 dark:border-gray-800 space-y-1">
